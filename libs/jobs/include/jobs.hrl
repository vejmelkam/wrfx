...
-record(job_desc, {id :: atom(),                                 % the id of the job (job_desc key)
		   cfg :: [{term(), term()}]                     % the configuration (a job-specific plist)
		  }).


%% A record of a finished job.
-record(job_report, {id :: atom(),                               % id of the job (job_desc key) 
		     job_name :: string(),                       % a unique job name
...
-record(job_activity, {id :: atom(),                             % the id of the job (job_desc key)
